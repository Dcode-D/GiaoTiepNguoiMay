...
class ReadMoreTextState extends State<CustomReadmore> {
  bool _readMore = true;
  @override
  void initState() {
    widget.textEventBus?.on<RemoteShowMoreEvent>().listen((event) {
      _setReadState(event.isshowingmore);
  ...
  void _setReadState(bool rstate){
    setState(() {
      _readMore = rstate;
    });
  }
